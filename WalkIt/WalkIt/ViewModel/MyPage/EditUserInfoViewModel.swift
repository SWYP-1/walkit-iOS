...
class EditUserInfoViewModel: ObservableObject {
    ...
    func loadView() async {
        ...
        birthMonth = Int(userManager.birthMonth) ?? 1
        birthDay = Int(userManager.birthDay) ?? 1
...
//        if(saveBirthYear != birthYear) { return true }
//        if(saveBirthMonth != birthMonth) { return true }
//        if(saveBirthDay != birthDay) { return true }
...
//        let month = String(format: "%02d", birthMonth)
//        let day = String(format: "%02d", birthDay)
        
//        let birthDate = String(birthYear) + "-" + String(birthMonth) + "-" + String(birthDay)
        let birthDate = "9999-09-09"
        do {
