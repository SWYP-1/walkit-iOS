        ...
        VStack(spacing: 10) {
            ZStack(alignment: .center) {
                ...
                VStack(spacing: 0) {
                    ...
                    GradientLinearSpinner(progress: (Double(vm.followerWalk?.walkProgressPercentage ?? "0") ?? 0) / 100, height: 15, firstColor: Color(hex: "#52CE4B"), lastColor: Color(hex: "#22A04C"), backgroundColor: Color(hex: "#FFFFFF"))
                }
                .padding(20)
                .frame(height: frameWidth * calcImageheghit)
            ...
            if(vm.followerWalk?.likeCount ?? 0 == 0) {
                ...
                HStack {
                    ...
                    .background(
                        Capsule()
                            .fill(vm.followerWalk?.liked ?? false ? Color(hex: "#FEF7D7") : Color(hex: "#FFFFFF"))
                            .stroke(Color(hex: "#EBEBEE"), lineWidth: vm.followerWalk?.liked ?? false ? 0 : 1)
                    )
                    .onTapGesture {
